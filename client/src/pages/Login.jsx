          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              <input 
                type="email" 
                placeholder="Email" 
                className="w-full p-4 border-2 border-[#10b981] rounded-full text-gray-800 dark:text-gray-100 focus:outline-none focus:border-[#059669] shadow-[0_0_15px_rgba(16,185,129,0.4)] hover:shadow-[0_0_20px_rgba(5,150,105,0.5)] bg-white dark:bg-gray-800 placeholder-gray-500 dark:placeholder-gray-400 font-medium transition-all"
                value={email}
